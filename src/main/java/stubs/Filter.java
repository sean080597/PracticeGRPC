...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            ...
            minRam_ = input.readMessage(stubs.Memory.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return stubs.FilterMessage.internal_static_Filter_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return stubs.FilterMessage.internal_static_Filter_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            stubs.Filter.class, stubs.Filter.Builder.class);
  }
   ...
   * @return The minRam.
   */
  public stubs.Memory getMinRam() {
    return minRam_ == null ? stubs.Memory.getDefaultInstance() : minRam_;
  }
  /**
   * <code>.Memory min_ram = 4;</code>
   */
  public stubs.MemoryOrBuilder getMinRamOrBuilder() {
    return getMinRam();
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof stubs.Filter)) {
      return super.equals(obj);
    }
    stubs.Filter other = (stubs.Filter) obj;
  ...
  public static stubs.Filter parseFrom(
  ...
  public static stubs.Filter parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static stubs.Filter parseFrom(
  ...
  public static stubs.Filter parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static stubs.Filter parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static stubs.Filter parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(stubs.Filter prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using stubs.Filter.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public stubs.Filter getDefaultInstanceForType() {
      return stubs.Filter.getDefaultInstance();
    }

    @java.lang.Override
    public stubs.Filter build() {
      stubs.Filter result = buildPartial();
    ...
    @java.lang.Override
    public stubs.Filter buildPartial() {
      stubs.Filter result = new stubs.Filter(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof stubs.Filter) {
        return mergeFrom((stubs.Filter)other);
      } else {
    ...
    public Builder mergeFrom(stubs.Filter other) {
      if (other == stubs.Filter.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      stubs.Filter parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (stubs.Filter) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        stubs.Memory, stubs.Memory.Builder, stubs.MemoryOrBuilder> minRamBuilder_;
    /**
     * <code>.Memory min_ram = 4;</code>
     * @return Whether the minRam field is set.
     */
     ...
     * <code>.Memory min_ram = 4;</code>
     */
    public Builder setMinRam(stubs.Memory value) {
      if (minRamBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.Memory min_ram = 4;</code>
     */
    public Builder mergeMinRam(stubs.Memory value) {
      if (minRamBuilder_ == null) {
        if (minRam_ != null) {
          minRam_ =
            stubs.Memory.newBuilder(minRam_).mergeFrom(value).buildPartial();
        } else {
          minRam_ = value;
        }
        onChanged();
     ...
     * <code>.Memory min_ram = 4;</code>
     */
    public stubs.Memory.Builder getMinRamBuilder() {
    ...
    public stubs.MemoryOrBuilder getMinRamOrBuilder() {
      if (minRamBuilder_ != null) {
        ...
        return minRam_ == null ?
            stubs.Memory.getDefaultInstance() : minRam_;
      }
    }
    /**
     * <code>.Memory min_ram = 4;</code>
  ...
  private static final stubs.Filter DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new stubs.Filter();
  }

  public static stubs.Filter getDefaultInstance() {
