...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            memory_ = input.readMessage(stubs.Memory.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return stubs.StorageMessage.internal_static_Storage_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return stubs.StorageMessage.internal_static_Storage_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            stubs.Storage.class, stubs.Storage.Builder.class);
  }
  ...
  public enum Driver
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return stubs.Storage.getDescriptor().getEnumTypes().get(0);
    }
   ...
   * @return The driver.
   */
  public stubs.Storage.Driver getDriver() {
    @SuppressWarnings("deprecation")
    stubs.Storage.Driver result = stubs.Storage.Driver.valueOf(driver_);
    return result == null ? stubs.Storage.Driver.UNRECOGNIZED : result;
  }

  public static final int MEMORY_FIELD_NUMBER = 2;
  private stubs.Memory memory_;
  /**
   ...
   * @return The memory.
   */
  public stubs.Memory getMemory() {
    return memory_ == null ? stubs.Memory.getDefaultInstance() : memory_;
  }
  /**
   * <code>.Memory memory = 2;</code>
   */
  public stubs.MemoryOrBuilder getMemoryOrBuilder() {
    return getMemory();
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (driver_ != stubs.Storage.Driver.UNKNOWN.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof stubs.Storage)) {
      return super.equals(obj);
    }
    stubs.Storage other = (stubs.Storage) obj;
  ...
  public static stubs.Storage parseFrom(
  ...
  public static stubs.Storage parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static stubs.Storage parseFrom(
  ...
  public static stubs.Storage parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static stubs.Storage parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static stubs.Storage parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(stubs.Storage prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using stubs.Storage.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public stubs.Storage getDefaultInstanceForType() {
      return stubs.Storage.getDefaultInstance();
    }

    @java.lang.Override
    public stubs.Storage build() {
      stubs.Storage result = buildPartial();
    ...
    @java.lang.Override
    public stubs.Storage buildPartial() {
      stubs.Storage result = new stubs.Storage(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof stubs.Storage) {
        return mergeFrom((stubs.Storage)other);
      } else {
    ...
    public Builder mergeFrom(stubs.Storage other) {
      if (other == stubs.Storage.getDefaultInstance()) return this;
      if (other.driver_ != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      stubs.Storage parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (stubs.Storage) e.getUnfinishedMessage();
     ...
     * @return This builder for chaining.
     */
    public Builder setDriver(stubs.Storage.Driver value) {
      if (value == null) {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        stubs.Memory, stubs.Memory.Builder, stubs.MemoryOrBuilder> memoryBuilder_;
    /**
     * <code>.Memory memory = 2;</code>
     * @return Whether the memory field is set.
     */
     ...
     * <code>.Memory memory = 2;</code>
     */
    public Builder setMemory(stubs.Memory value) {
      if (memoryBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.Memory memory = 2;</code>
     */
    public Builder mergeMemory(stubs.Memory value) {
      if (memoryBuilder_ == null) {
        if (memory_ != null) {
          memory_ =
            stubs.Memory.newBuilder(memory_).mergeFrom(value).buildPartial();
        } else {
          memory_ = value;
        }
        onChanged();
     ...
     * <code>.Memory memory = 2;</code>
     */
    public stubs.Memory.Builder getMemoryBuilder() {
    ...
    public stubs.MemoryOrBuilder getMemoryOrBuilder() {
      if (memoryBuilder_ != null) {
        ...
        return memory_ == null ?
            stubs.Memory.getDefaultInstance() : memory_;
      }
    }
    /**
     * <code>.Memory memory = 2;</code>
  ...
  private static final stubs.Storage DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new stubs.Storage();
  }

  public static stubs.Storage getDefaultInstance() {
